...
def greet():
    ...
    conn.commit()
    conn.close()
    SR.speak("\nHello there,I'm your Voice Assistant. How may I help you?")
...
def mainframe():
    ...
    try:
        while(True):
            ...
            if there_exists(['search wikipedia for','from wikipedia'],query):
            ...
            elif there_exists(['tell  jokes','tell me a joke','tell me some jokes','i would like to hear some jokes',"i'd like to hear some jokes"],query):
                ...
                SR.speak("I'm your voice assistant and I'm here to serve you.")
                ...
                break
            elif there_exists(['play some songs on youtube','i would like to listen some music','play songs on youtube'],query):
                SR.speak("Opening youtube")
            ...
            elif there_exists(['what is meant by','what does it mean by'],query):
                results=wikipedia.summary(query,sentences=2)
                SR.speak("According to wikipedia:\n")
                SR.speak(results)
            ...
            elif there_exists(['would like to play some games','play some games',' play a game',' games','want to play game','want to play games','play games','open games','play game','open game'],query):
                ...
                codepath=r"C:\Users\Mike\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Visual Studio Code"
                ...
                os.startfile(r"C:\Users\Mike\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Windows PowerShell\Windows PowerShell.lnk")
                break
                ...
                os.startfile(r'C:\Users\Mike\AppData\Local\WhatsApp\WhatsApp.exe')
                break
